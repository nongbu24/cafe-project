...
| 회원 | [`user.md`](user.md) | 내 정보 조회, 비밀번호 변경, 관리자 회원 목록 조회, 관리자 회원 단건 조회                    |
| 메뉴 | [`menu.md`](menu.md) | 카페 메뉴 목록, 최근 7일 인기 메뉴 목록, 관리자 메뉴 생성, 관리자 메뉴 상태 변경, 관리자 메뉴 목록 조회 |
| 장바구니 | [`cart.md`](cart.md) | 장바구니 조회, 장바구니 항목 수량 변경, 장바구니 전체 비우기                              |
| 포인트 | [`point.md`](point.md) | 포인트 충전                                                          |
| 주문 | [`order.md`](order.md) | 메뉴 즉시 주문·결제, 장바구니 주문·결제, 데이터 수집 플랫폼 전송                          |
